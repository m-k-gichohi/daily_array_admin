...
@Component({
  ...
  imports: [FormsModule, RouterLink, AngularEditorModule, ImageUploadComponent],
...
export class ProductFormComponent implements OnInit {
  ...
  async save(): Promise<void> {
    ...
    if (
      ...
      !this.form.amazon_url || !this.form.asin
    ) {
      this.saveError.set(
        "Please fill in all required fields (name, slug, category, Amazon URL,Product ASIN number).",
      );
      return;
    }
